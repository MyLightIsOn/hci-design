...
<figure>
  <img src="/lab-notes-images/004/2.png" alt="Diagram titled 'Workflows shape skills' comparing an old full-detection-loop workflow to a new AI-assisted workflow. Old workflow practices full detection (find, classify, decide), judgment (apply experience and context), and attention and search (actively scan, compare, decide under uncertainty) — building the foundation of core expertise. New AI-assisted workflow practices verification (check what the AI found), acceptance (agree with the suggestion, move on), and gap-noticing (notice what the AI might have missed, only if you're looking) — building on the foundation rather than maintaining it. Footer warning: residual skill is not self-sustaining; if the foundation erodes, verification, acceptance, and gap-noticing erode with it." />
