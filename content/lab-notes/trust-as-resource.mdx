...
<figure>
  <MDXImage src="/lab-notes-images/001/1.png" alt="The trust calibration spectrum. Disuse and misuse sit on opposite ends. Appropriate reliance is the primary design target." />
...
<figure>
  <MDXImage src="/lab-notes-images/001/2.png" alt="Trustworthiness rests on three independent dimensions. A deficit in any one undermines the whole. Integrity failures do not remain isolated. Instead, they reach back and retroactively revise perceptions of ability and benevolence." />
...
<figure>
  <MDXImage src="/lab-notes-images/001/3.png" alt="Trust accumulates slowly through reliable outputs and collapses sharply after a single visible failure. Recovery is slow and incomplete. The previous trust peak is rarely reached again." />
...
<figure>
  <MDXImage src="/lab-notes-images/001/4.png" alt="Two outputs, two trust profiles of an accessibility documentation tool." />
