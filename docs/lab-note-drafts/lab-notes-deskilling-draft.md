...
None of this argues against the architecture. It argues that the architecture has a maintenance cost nobody is budgeting. If a system consumes expert judgment as its backstop, it should be designed to keep that judgment exercised, the way aviation eventually accepted that automated cockpits require deliberate manual practice. Expertise, like trust, is a resource the system spends. It should be stewarded like one.
